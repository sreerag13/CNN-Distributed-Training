...
def get_progress():
    global progress
    return jsonify({'progress': progress,"flag":flag}), 200
...
def train_local_model(tensor,label):
    ...
    progress = f"Finished training in Server 2 Number of epoch 5 , Accuracy: {history.history['accuracy'][-1]}, Loss :{history.history['loss'][-1]}"
...
def get_global_model():
    ...
    return 'Child Server 2 Recieved Global Model', 200
